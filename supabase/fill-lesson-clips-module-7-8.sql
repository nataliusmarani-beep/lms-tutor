...
-- label to the best topic, setting its EN + ID video and bilingual practice
-- task. Two Teams topics (Mentions, Do Not Disturb) have no Indonesian video
-- available, so ChecklistSection falls back to the English video there.
...
BEGIN
  ...
  UPDATE module_checklist_items SET
    video_url='https://www.youtube.com/watch?v=tlo4QUAhzgU', video_url_id='https://www.youtube.com/watch?v=iA-8JKNI1xI', practice_task='Add branching so one answer skips to a later question.', practice_task_id='Tambahkan percabangan agar satu jawaban melompat ke pertanyaan berikutnya.'
  ...
  UPDATE module_checklist_items SET
    video_url='https://www.youtube.com/watch?v=vyEYe0_6o6Y', video_url_id='https://www.youtube.com/watch?v=1X4GzArlW90', practice_task='Open the responses in Excel for further analysis.', practice_task_id='Buka respons di Excel untuk dianalisis lebih lanjut.'
  ...
  UPDATE module_checklist_items SET
    video_url='https://www.youtube.com/watch?v=IFzBv6mN6ts', video_url_id='https://www.youtube.com/watch?v=RAhoegoNm3M', practice_task='Add a choice question, a text question, and a rating question.', practice_task_id='Tambahkan pertanyaan pilihan, teks, dan rating.'
  ...
  UPDATE module_checklist_items SET
    video_url='https://www.youtube.com/watch?v=cbmADc6X9GE', video_url_id='https://www.youtube.com/watch?v=SuwDJLdOUBw', practice_task='Change the form''s theme or background.', practice_task_id='Ubah tema atau latar formulirmu.'
  ...
  IF v_mod IS NULL THEN RAISE EXCEPTION 'module not found'; END IF;
  UPDATE module_checklist_items SET
    video_url='https://www.youtube.com/watch?v=hhhQEJF9xOo', video_url_id='https://www.youtube.com/watch?v=_YlXSrEsLWQ', practice_task='Open the Assignments tab and turn in an assignment.', practice_task_id='Buka tab Assignments dan kumpulkan sebuah tugas.'
  ...
  UPDATE module_checklist_items SET
    video_url='https://www.youtube.com/watch?v=QhjXzpiUKxc', video_url_id='https://www.youtube.com/watch?v=x2uBO3ktaro', practice_task='Join a meeting and share your screen.', practice_task_id='Bergabung ke rapat dan bagikan layarmu.'
  ...
  UPDATE module_checklist_items SET
    video_url='https://www.youtube.com/watch?v=CNAF3NBvtPM', video_url_id='https://www.youtube.com/watch?v=EeJjB9vMDco', practice_task='Post a message in a channel and reply to one.', practice_task_id='Kirim pesan di channel dan balas satu pesan.'
